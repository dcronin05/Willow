...
- **Retrospective Documentation:** Do not eagerly over-document code while actively iterating on a feature or fixing a bug. Wait for the user to explicitly confirm that the recent changes or features are "working well" or "look good" before you go back and update the documentation for the newly added/modified code.
